        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">                    
                    ...
                    <form name="frm_add" id="frm_add" class="form-horizontal" action="{{route('hotel.store')}}" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="modal-body">             
                            ...
                            <div class="form-group"><label class="col-lg-3 control-label">Katerangan</label>
                            ...
                            <div class="form-group"><label class="col-lg-3 control-label">Gambar Hotel</label>

                                <div class="col-lg-12">

                                    <input type="file" name="gambar" placeholder="Gambar Hotel" class="form-control">
